...
const SocialMediaTags = () => {
    return (
        <footer className="pv4 ph3-ns tc footer sticky-footer">
            <a className="redBackgroundlink dim gray dib h2 w2 br-100 ma3 pa2" rel="noopener noreferrer" target="_blank" href='https://www.facebook.com/earle.s.poole' title="">
                <svg 
                    data-icon="facebook"
                    width="48"
                    height="48"
                    viewBox="-8 -8 50 50" 
                    className="moon-gray ba b--moon-gray br4 shadow-5 redBackground"
                >
            ...
            <a className="link dim gray dib h2 w2 br-100 ma3 pa2" rel="noopener noreferrer" target="_blank" href='https://www.linkedin.com/in/earle-poole/' title="">
                <svg 
                    ...
                    height="48"
                    viewBox="-7 -7 39 39" 
                    className="ba b--moon-gray br4 shadow-5 redBackground"
                >
